...
// Imports for use on the 100objects site
...
head.appendChild( addImport('https://www.library.virginia.edu/bower_components/polymer/lib/elements/dom-bind.html') );
head.appendChild( addImport('https://www.library.virginia.edu/bower_components/iron-ajax/iron-ajax.html') );
head.appendChild( addImport('https://www.library.virginia.edu/bower_components/uvalib-imageviewer/uvalib-imageviewer.html') );
